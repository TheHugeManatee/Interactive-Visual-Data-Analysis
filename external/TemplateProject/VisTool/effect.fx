...
// File: effect.fx
//
// The first effect file for our visualization tool including a pass
// for rendering a simple triangle.
//
...
//in world space for the first three vertices (id's 0, 1 and 2).
...
technique11 Simple
{
	// Pass for rendering a simple triangle 
	// (a pass corresponds to a rendering pipeline configuration, i.e. a set of states and shaders)
	pass P0
	{
